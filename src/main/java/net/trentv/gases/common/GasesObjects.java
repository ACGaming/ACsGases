...
public class GasesObjects
{
	...
	public static final GasType COAL_DUST = new GasType("coal_dust", 0x000000, 2, 0, Combustibility.EXPLOSIVE).setCohesion(6).setDissipation(2, 4).setCreativeTab(Gases.CREATIVE_TAB);
	...
	public static final GasType VOID_GAS = new GasTypeVoid("void", 0x222222, 0, -1, Combustibility.NONE).registerEntityReaction(new EntityReactionDamage(DAMAGE_SOURCE_VOID, 8)).setCreativeTab(Gases.CREATIVE_TAB);
	...
	public static final GasType CHLORINE = new GasType("chlorine", 0xC2F29C9F, 1, 8, Combustibility.NONE).setCreativeTab(Gases.CREATIVE_TAB);
	public static final GasType FININE = new GasType("finine", 0xFFFFFF, 0, 0, Combustibility.NONE).setCohesion(16).setCreativeTab(Gases.CREATIVE_TAB).setTexture(new ResourceLocation(Gases.MODID, "block/finine"), false).registerEntityReaction(new EntityReactionFinine());
	...
	public static final GasType ELECTRIC = new GasType("electric", 0x1F7F7F7F, 0, 0, Combustibility.NONE).setCohesion(16).setCreativeTab(Gases.CREATIVE_TAB);
	public static final GasType CORROSIVE = new GasType("corrosive", 0x1F1FDF7F, 0, 0, Combustibility.NONE).setCohesion(16).setCreativeTab(Gases.CREATIVE_TAB);

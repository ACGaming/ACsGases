...
public class GasesMainConfigurations
{
	...
	public static class Gases
	{
		...
		{
			@Config.Comment({"Blocks that can emit smoke when updated", "Syntax: modid:block or ore dictionary name"})
			@Config.Name("Blocks")
			public String[] blocks = new String[] {"minecraft:fire"};

			@Config.Comment("The amount of smoke that will be generated by the listed blocks (1-16)")
			@Config.Name("Smoke Amount")
			@Config.RangeInt(min = 1, max = 16)
			public int smokeAmount = 8;
		}
